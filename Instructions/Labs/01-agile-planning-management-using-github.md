...
1. **[Short description]** テキスト ボックスに「**`Introduction to GitHub Projects`**」と入力し、**[Save]** を選択します。
...
1. テキスト ボックスに「**`Missing Wiki`**」と入力し、キーボードの **Enter** キーを押します。 これにより、新しい下書きの項目が **[Todo]** 列に追加されます。
...
1. **[DevOps Core Intro プロジェクト]** ページの **[Todo]** 列で、**[+ 項目の追加]** を選択します。
1. テキスト ボックスに「**`Additional collaborators needed`**」と入力し、キーボードの **Enter** キーを押します。 これにより、新しい下書きの項目が **[Todo]** 列に追加されます。
